...
conformance!(
    ...
    // ADR 001 D9's dead-letter queue, read back and recovered.
    a_parked_row_can_be_read_back_with_everything_needed_to_diagnose_it,
    listing_parked_rows_honours_its_limit_and_skips_live_work,
    an_idle_store_has_no_dead_letters,
    reviving_a_parked_post_makes_it_leasable_again_with_a_full_budget,
